...
int main()
{
	...
	playerRenderer->AddModel("../resources/models/cube.obj", "../resources/shaders/simple.vert", "../resources/shaders/simple.frag");
	std::shared_ptr<Material> material = player->AddComponent<Material>("../resources/textures/cat.png");
	player->GetComponent<Transform>()->SetTransform(glm::vec3(2, 0, 0), 180.0f, glm::vec3(1, 1, 1));
